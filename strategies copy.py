...
class Strategies():
    ...
    def filter_and_apply_strategies(self, df):
        ...
        relevant_columns = [
            ...
            'EMA50', 'PSARl_0.02_0.2', 'OBV_RoC','ATR','Rolling_Std_10','Rolling_Std_50'
        ]
    ...
    def apply_alternative_strategy_states(self):
        ...
        try:
            ...
            strategies = ['RSI Strategy', 'RSI Strategy2', 'RSI14_OBV_RoC Strategy', 'RSIMACD Strategy', 'RSICMF Strategy', 'RSI OBV Strategy', 'OBV Strategy', 'MACD Strategy', 'CMF Strategy', 'EMA5 PSAR Strategy','Rolling Std10 Strategy','Rolling Std50 Strategy']
