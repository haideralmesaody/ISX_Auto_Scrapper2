...
class DataCalculatorASE:
    ...
    def calculate_all(self, ticker):
        ...
        raw_file_path = f"ASE_raw_{ticker}.csv"
        ...
        indicators_file_path = f"ASE_indicators_{ticker}.csv"
        ...
        try:
            self.logger.log_or_print("Calculating SMAs", level="INFO", module="Data_Calculator")
            self.calculate_sma(df)
            self.logger.log_or_print("Calculating RSIs", level="INFO", module="Data_Calculator")
            self.calculate_rsi(df)
            self.logger.log_or_print("Calculating Stochastic Oscillators", level="INFO", module="Data_Calculator")
            self.calculate_stochastic_oscillator(df)
            self.logger.log_or_print("Calculating CMF", level="INFO", module="Data_Calculator")
            self.calculate_cmf(df)
            self.logger.log_or_print("Calculating MACD", level="INFO", module="Data_Calculator")
            self.calculate_macd(df)
            self.logger.log_or_print("Calculating OBV", level="INFO", module="Data_Calculator")
            self.calculate_obv(df)
            #calcualte ema5
            self.logger.log_or_print("Calculating EMA5", level="INFO", module="Data_Calculator")
            self.calculate_ema5(df)
            #calculate ema10
            #self.logger.log_or_print("Calculating EMA10", level="INFO", module="Data_Calculator")
            self.calculate_ema10(df)
            #calculate ema20
            #self.logger.log_or_print("Calculating EMA20", level="INFO", module="Data_Calculator")
            self.calculate_ema20(df)
            #calculate ema50
            #self.logger.log_or_print("Calculating EMA50", level="INFO", module="Data_Calculator")
            self.calculate_ema50(df)
            #calculate ema200
            #self.logger.log_or_print("Calculating EMA200", level="INFO", module="Data_Calculator")
